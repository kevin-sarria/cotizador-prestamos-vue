...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="flex justify-between mt-10">
      ...
      <Button
        :operador="'-'"
        @fn="handleChangeDecrementar"
      />

      <Button
        :operador="'+'"
        @fn="handleChangeIncrementar"
      />
    ...
    <div class="my-5">
      ...
      <p v-else class="text-center mt-5 text-gray-500">Añade una cantidad y un plazo a pagar</p>
